...
- [ ] `file_write` — запись файлов (с подтверждением)
- [ ] `list_directory` — список файлов в директории
- [ ] `shell_execute` — выполнение команд (с подтверждением)
- [ ] `web_search` — поиск в интернете
- [ ] `web_fetch` — загрузка содержимого URL

**Критерии готовности:**
- Все 6 базовых инструментов работают
- Инструменты покрыты тестами
...
- [ ] Система уровней риска (LOW/MEDIUM/HIGH)
- [ ] Confirmation prompts для опасных операций
- [ ] Whitelist разрешенных команд/путей
...
- Пользователь может видеть, что будет выполнено
