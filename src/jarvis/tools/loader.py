...
class ToolLoader:
    ...
    def load_from_spec(self, spec: dict[str, Any]) -> Tool | None:
    ...
    def load_from_class(self, tool_class: type[Tool], **kwargs: Any) -> Tool | None:
    ...
    def load_from_factory(self, factory: Callable[[], Tool]) -> Tool | None:
