...
3. **Grill is mandatory** before scaffolding (Phase 1) AND after (Phase 5). Do not skip on "small task" — see the grill trigger checkbox (`~/.claude/reference/engineering-principles.md`).
